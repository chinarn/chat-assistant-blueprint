...
const responseMap = {
    ...
    8: "1. With numerous OTT entrants, consumers are suffering from subscription fatigue. In fact, they are looking for a one stop shop platform where OTT services are integrated in one place. <br>2. Astro offers flexibility and convenience with new packs where customers can get the convenience of accessing a variety of content via Ultra Box as the single remote-control solution. <br>3. In addition, there will be cost savings for Astro customers to purchase both Netflix and Astro together. Even better deals available if customers also subscribe to broadband for a better-connected experience.",
    9: "•eGG Network<br>•Astro SuperSport<br>•Astro SuperSport 2<br>•FOX SPORTS<br>•FOX SPORTS 2<br>•Eurosport<br>•Astro SuperSport 3<br>•Astro Supersport4<br>•FOX SPORTS 3<br>•beIn Sports<br>•beIN Sports MAX<br>•Arena HD<br>•FOX SPORTS 2 HD<br>•FOX SPORTS 3 HD<br>•Astro Supersport 2 HD<br>•Astro SuperSport 3 HD<br>•Astro SuperSport 4 HD"
}
